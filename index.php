...
<head>
    ...
    <meta name="Description" content="Юридическое сопровождение для бизнеса, самозанятых, НКО и граждан. В Воронеже и удаленно в других регионах РФ. Широкий спектр юридических услуг. Правовой аутсорс: комплекс юридических услуг и отдельные услуги по запросу. Обеспечиваю Вам спокойные и безопасные условия для работы, развития Вашего дела, решения личных вопросов. Стремлюсь к взаимовыгодному партнерству и сотрудничеству. Использую индивидуальный подход, подбираю гибкие решения. Оказываю профессиональную юридическую помощь в различных сферах. Экономлю Ваши нервы, время и деньги. Выстраиваю честные отношения и гарантирую прозрачную стоимость услуг." />
...
<main>
    ...
    <section class="news pb-5">
        ...
        <div class="news-wrap container d-flex align-items-start flex-wrap">
            
        </div>
        <button id="all-news" class="btn-hovers btn-cases ms-auto me-auto outlines-btn">Смотреть все новости</button>
    </section>
    <section class="form">
